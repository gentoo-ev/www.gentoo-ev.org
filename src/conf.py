...
BLOG_AUTHOR = "Förderverein Gentoo e.V."  # (translatable)
BLOG_TITLE = "Förderverein Gentoo e.V."  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://gentoo-ev.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://gentoo-ev.org/"
BLOG_EMAIL = "www@gentoo-ev.org"
BLOG_DESCRIPTION = "Webauftritt des Förderverein Gentoo e.V."  # (translatable)
...
def mynav(icon, text):
   return f'<span class="fa fa-fw fa-{icon}"></span> {text}'

NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ((("/ueber-uns/", mynav("info-circle", "Über uns")),
          ("/downloads/Mitgliedsantrag.pdf",
           mynav("user-plus", "Mitglied werden")),
          ("/ressourcen/", mynav("folder-open", "Ressourcen")),
          ("/rechtliches/", mynav("balance-scale", "Rechtliches")),
          ("/spenden/", mynav("heart", "Spenden"))),
         "Verein"),
        ((("/downloads/", mynav("download", "Downloads")),
          ("/dokumentation/", mynav("book", "Dokumentation")),
          ("/support/", mynav("support", "Unterstützung"))),
         "Distribution"),
        ((("https://www.gentoo.org/", mynav("home", "www.gentoo.org")),
          ("https://wiki.gentoo.org/wiki/Handbook:Main_Page/de",
           mynav("book", "Handbuch")),
          ("https://wiki.gentoo.org/", mynav("file-text-o", "Wiki")),
          ("https://bugs.gentoo.org/", mynav("bug", "Bugs")),
          ("https://packages.gentoo.org/", mynav("hdd-o", "Pakete")),
          ("https://forums.gentoo.org/", mynav("comments-o", "Foren")),
          ("https://planet.gentoo.org/", mynav("rss", "Planet")),
          ("https://archives.gentoo.org/",
           mynav("archive", "Mailinglisten-Archiv")),
          ("https://devmanual.gentoo.org/", mynav("book", "Devmanual")),
          ("https://gitweb.gentoo.org/", mynav("code", "Gitweb"))),
         "gentoo.org"),
        ("/kontakt/", "Kontakt"),
    ),
}
...
LOGO_URL = '/images/gentoo-signet.svg'
...
<style>
  #logo { width: 4rem; height: 4rem; margin: 0.6rem 0.6rem 0.6rem 0; }
</style>
'''
