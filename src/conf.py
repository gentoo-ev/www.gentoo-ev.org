...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ((("/downloads/", "Downloads"),
          ...
          "Distribution"),
        ((("https://www.gentoo.org", "www.gentoo.org"),
          ("https://wiki.gentoo.org/wiki/Handbook:Main_Page/de", "Handbuch"),
          ("https://wiki.gentoo.org", "Wiki"),
          ("https://bugs.gentoo.org", "Bugs"),
          ("https://packages.gentoo.org", "Pakete"),
          ("https://forums.gentoo.org", "Foren"),
          ("https://planet.gentoo.org", "Planet"),
          ("https://archives.gentoo.org", "Mailinglisten-Archiv"),
          ("https://devmanual.gentoo.org", "Devmanual"),
          ("https://gitweb.gentoo.org", "Gitweb")),
          "gentoo.org"),
        ("/kontakt/", "Kontakt"),
    ),
}
